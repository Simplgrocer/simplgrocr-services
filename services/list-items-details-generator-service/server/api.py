...
from .routes import list_items_details_generator_router
...
app = FastAPI(
    title="List items details generator service",
    description="""
...
app.include_router(
    list_items_details_generator_router,
    prefix="/generate-list-items-details"
)
